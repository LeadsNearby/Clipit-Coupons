...
function clipit_plugin_scripts()  {
	if (!is_admin()) {
		...
		wp_register_script('coupon-commons', plugins_url('js/coupon-commons.js',__FILE__));
		wp_enqueue_script('coupon-commons');
		wp_register_script( 'g-plusone', 'https://apis.google.com/js/platform.js', TRUE);
		wp_enqueue_script('g-plusone');
		wp_register_script('countdown', plugins_url('js/countdown.js',__FILE__));
